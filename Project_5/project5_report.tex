...
\begin{figure*}[h!]
  \centering
  \subfloat{\includegraphics[width=9cm]{figs/prob_ab_legend.pdf}}
  \\
  \subfloat{\includegraphics[width=9cm]{figs/prob_b_varb_1.png}}
  \subfloat{\includegraphics[width=9cm]{figs/prob_b_varb_2.png}}
  \\
  \subfloat{\includegraphics[width=9cm]{figs/prob_b_varb_3.png}}
  \subfloat{\includegraphics[width=9cm]{figs/prob_b_varb_4.png}}
...
\begin{figure*}
  ...
  \subfloat{\includegraphics[width=9cm]{figs/prob_ab_legend.pdf}}
  \\
  \subfloat{\includegraphics[width=9cm]{figs/prob_c_fig_0.png}}
  \subfloat{\includegraphics[width=9cm]{figs/prob_c_fig_1.png}}
  \\
  \subfloat{\includegraphics[width=9cm]{figs/prob_c_fig_2.png}}
  \subfloat{\includegraphics[width=9cm]{figs/prob_c_fig_3.png}}
...
\begin{figure*}
  ...
  \subfloat{\includegraphics[width=9cm]{figs/prob_ab_legend.pdf}}
  \\
  \subfloat{\includegraphics[width=9cm]{figs/prob_d_fig_0.png}}
  \subfloat{\includegraphics[width=9cm]{figs/prob_d_fig_1.png}}
  \\
  \subfloat{\includegraphics[width=9cm]{figs/prob_d_fig_2.png}}
  \subfloat{\includegraphics[width=9cm]{figs/prob_d_fig_3.png}}
...
\begin{figure*}
  ...
  \subfloat{\includegraphics[width=9cm]{figs/prob_ab_legend.pdf}}
  \\
  \subfloat{\includegraphics[width=9cm]{figs/prob_e_fig_0.png}}
  \subfloat{\includegraphics[width=9cm]{figs/prob_e_fig_1.png}}
  \\
  \subfloat{\includegraphics[width=9cm]{figs/prob_e_fig_2.png}}
  \subfloat{\includegraphics[width=9cm]{figs/prob_e_fig_3.png}}
