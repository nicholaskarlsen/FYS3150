...
\begin{figure*}[h!tb]
  ...
  \subfloat{\includegraphics[width=8.5cm]{figs/prob_b_varb_1.png}}
  \subfloat{\includegraphics[width=8.5cm]{figs/prob_b_varb_2.png}} \\
  \subfloat{\includegraphics[width=8.5cm]{figs/prob_b_varb_3.png}}
  \subfloat{\includegraphics[width=8.5cm]{figs/prob_b_varb_4.png}}
...
\begin{figure*}[h!tb]
  ...
  \subfloat{\includegraphics[width=8.5cm]{figs/prob_b_std_1.pdf}}
  \subfloat{\includegraphics[width=8.5cm]{figs/prob_b_std_2.pdf}} \\
  \subfloat{\includegraphics[width=8.5cm]{figs/prob_b_std_3.pdf}}
  \subfloat{\includegraphics[width=8.5cm]{figs/prob_b_std_4.pdf}}
  \caption{\label{fig:standard deviations b}The standard deviations for each $b$ in the Monte Carlo solutions shown in Fig.~\ref{fig:ab_plots}, consisting of 100 trials each.}
\end{figure*}

\begin{figure*}[h!tb]
  \subfloat{\includegraphics[width=8.5cm]{figs/prob_ab_legend.pdf}}
  \\
  \subfloat{\includegraphics[width=8.5cm]{figs/prob_c_fig_0.png}}   
  \subfloat{\includegraphics[width=8.5cm]{figs/prob_c_fig_1.png}}\\
  \subfloat{\includegraphics[width=8.5cm]{figs/prob_c_fig_2.png}}   
  \subfloat{\includegraphics[width=8.5cm]{figs/prob_c_fig_3.png}}   
  \caption{\label{fig:prob c}The SIRS model with vital dynamics for initial state $S_0=300, I_0=100, R_0=0$ and constants $a=4, b=1, c=0.5$.}
\end{figure*}
