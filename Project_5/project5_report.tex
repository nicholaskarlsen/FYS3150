...
\section{Theory, Algorithms and Methods}  
  ...
  \subsection{SIRS Model}
    ...
    \begin{itemize}
      ...
      \item rate of tecovery
      \item rate of tmmunity loss
    \end{itemize}

    respectively. This system can also be modelled as a Stochastic system described as a Markov Chain, shown as a Markov diagram in Fig.~\ref{fig:SIRS diagram}. If we consider a small, finite timeinterval $\Delta t$, we can approximate the transition probabilities $P(x_i \rightarrow x_j)$ from Eqn.~\ref{eqn:transition rates}
